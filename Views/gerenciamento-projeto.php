...
<head>
    ...
    <?php
        $tituloPagina = 'Gerenciamento de Projeto'; include_once 'menu.php'
    ?>

    <body class="corpo-ger-projetos">
        <main class="gerenciamento-projeto">
            ...
            <!-- =========================================== TABELA =============================================-->
            <div class="tabela-wrapper tabela-projeto">
                <table>
                    <thead>
                        <tr>
                            <th data-col="0">
            ...
            <!-- Fecha .main-content e .menu abertos pelo menu.php. Necessário para que o conteúdo
                fique dentro do flex row da sidebar, permitindo o comportamento de "empurrar"
                quando o menu lateral abre/fecha. -->
                </div>
            </div>
        <main>
    </body>
